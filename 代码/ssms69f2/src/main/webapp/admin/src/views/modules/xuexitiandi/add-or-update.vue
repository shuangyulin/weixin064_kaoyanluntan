    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="书籍分类" prop="shujifenlei">
          <el-select v-model="ruleForm.shujifenlei" placeholder="请选择书籍分类">
            <el-option
...
export default {
  ...
  created() {
	this.ruleForm.chubanshijian = this.getCurDate()
  ...
  methods: {
	...
	this.ruleForm.tushujianjie = this.ruleForm.tushujianjie.replace(reg,'../../../ssms69f2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
